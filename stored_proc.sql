...
# But, if we are considering multiple statements, then we need to use different delimiters like $$ or //. The delimiter is a type of function in SQL. Using another delimiter which is //.